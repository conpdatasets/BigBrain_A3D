...
This dataset contains the Atelier3D client files for viewing the BigBrain model from the BigBrain release 2015 
published in the [BigBrain Project website](https://bigbrainproject.org).

Atelier3d is a licensed proprietary software developed at the NRC in Ottawa. Note that the Atelier3d viewer itself is not provided on this dataset.
